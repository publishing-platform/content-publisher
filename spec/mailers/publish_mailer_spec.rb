RSpec.describe PublishMailer do
  ...
  describe "#publish_email" do
    it "creates an email for the user" do
      edition = create(:edition, :published, base_path: "/news/some-great-news")
      ...
      expect(mail.body.to_s).to include("https://www.test.publishing-platform.co.uk/news/some-great-news")
