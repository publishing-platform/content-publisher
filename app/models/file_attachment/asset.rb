...
# file uploaded as part of a FileAttachment::Revision. It is used to track the state
...
class FileAttachment::Asset < ApplicationRecord
  ...
  def asset_manager_id
    ...
    # https://github.com/alphagov/asset-manager/blob/main/docs/api.md#create-an-asset
