...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: URI(PublishingPlatformLocation.external_url_for("content-publisher")).host }
  ...
  config.hosts = [
    /content-publisher\..*\.publishing-platform.co.uk$/,
  ]
